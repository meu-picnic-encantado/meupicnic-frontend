      ...
      <section className="relative bg-gradient-to-br from-[#e8f2f7] via-[#f0f7fb] to-[#a8d4f0] py-20 md:py-32">
        <div className="container px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-[#3b7aa4] mb-8 leading-relaxed max-w-3xl mx-auto">
              {t.hero.description}
            </p>
            <Button
              asChild
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            <Card className="border-2 border-[#5a9bc4] hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full bg-[#e8f2f7] flex items-center justify-center">
      ...
      <section className="py-20 bg-gradient-to-br from-[#e8f2f7] to-[#f0f7fb]">
        <div className="container px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-2 border-[#5a9bc4] bg-white/80">
              <CardContent className="pt-6">
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full bg-[#f0f7fb] flex items-center justify-center">
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-[#1a3a4a] leading-relaxed mb-8">
